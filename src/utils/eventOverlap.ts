...
export function convertEventToDateRange({ date, startTime, endTime }: Event | EventFormData) {
  return {
...
export function isOverlapping(event1: Event | EventFormData, event2: Event | EventFormData) {
...
export function findOverlappingEvents(newEvent: Event | EventFormData, events: Event[]) {
